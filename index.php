...
<!--لتغيير محتوى صفحة الاندكس لما الادمن بده يغير اشي بالمحتوى تبع السلايدر فاي اشي بغيره الادمن بصفحة ابديت سلايدر رح يتغير مباشرة بالصفحة الاندكس-->
<!--$index:اريه بتبلش من الصفر -->
                <?php foreach($sliders as $index => $slider):?>
                <!-- Slide <?= $index+1?> -->
                <!-- $index == 0 ? 'active': لازم اول سلايد (اول صورة) هي تكون اكتف والباقي مش اكتف عشان نقدر نتنقل بين الصور الي بكونو كيرسل --->
